...
def _require_descriptor_traversal(request: pytest.FixtureRequest) -> None:
    """Skip traversal-bound boundary tests where the runtime lacks it.
...
@pytest.mark.posix_traversal_independent  # static scan; runtime probe tolerates refusal
...
@pytest.mark.posix_traversal_independent  # synthetic static-walk probe
...
@pytest.mark.posix_traversal_independent  # static tree probe, no selection run
...
@pytest.mark.posix_traversal_independent  # synthetic shadow-tree probe
