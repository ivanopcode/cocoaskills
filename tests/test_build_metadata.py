...
# The released suite at RELEASED_SUITE_PIN publishes expected/marker-v2.json,
# the marker-v2 writer golden this manager's own marker output is compared
# against.  That corpus declares protocol_version 1.0.0-rc.9 and is republished
# unchanged at the accepted revision 1.0.0-rc.10
# (build_repository.PROTOCOL_VERSION), so the digest below authenticates a root
# served by either revision.  The retired rc.5 suite (sha256:b6f56aac...)
# carries no writer golden and no longer authenticates here at all.
